...
public class FontShader extends AbstractShaderProgram {
    private static final String VERTEX_PATH = "resources/shaders/font/FontVertexShader.vsh";
    private static final String FRAGMENT_PATH = "resources/shaders/font/FontFragmentShader.fsh";
